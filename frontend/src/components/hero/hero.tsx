...
import { HERO, GENERATOR } from "@/lib/landing";
...
function HeroIllustration() {
  return (
    <div className="relative">
      <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-border/60 bg-card shadow-2xl shadow-black/20">
        <div
          aria-hidden
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
          <div className="space-y-3">
            ...
            <Skeleton className="h-32 w-full rounded-lg bg-foreground/10 md:h-40" />
        ...
        <div className="absolute left-6 top-6 rounded-lg border border-border/40 bg-background/60 px-3 py-2 text-xs text-muted-foreground backdrop-blur-sm">
          Concept preview
        </div>
      </div>
